...
export default function Listen() {
  ...
  return (
    <section
      id="listen"
      className={`w-full mt-16 lg:mt-56 reveal${
    ...
    >
      <Container customClasses="flex flex-col lg:flex-row">
        <div className="flex flex-col justify-center basis-2/4 lg:max-w-lg xl:max-w-2xl 2xl:max-w-4xl">
          <p>Listen to my first album:</p>
          <h2 className="font-bold text-6xl pb-6">Bubu Cuartet</h2>
          <p>
            My first album features original compositions promoting dynamic
            interaction between musicians' improvisations.
          </p>
