      ...
      <Container customClasses="flex flex-col lg:items-end lg:justify-end lg:absolute lg:left-1/2 lg:-translate-x-1/2">
        <div className="flex justify-end flex-col lg:items-end lg:max-w-md xl:max-w-2xl 2xl:max-w-4xl">
          <div className="flex flex-col max-w-4xl lg:text-right">
            <h2 className="font-bold text-6xl pb-6">Contact me</h2>
            <p>
              And get me a drink in case you around. <br></br>Email me at{" "}
              <a
                className="text-yellow-btn-primary underline underline-offset-4 hover:text-yellow-600"
                href="juanimasmusic@gmail.com"
                target="_blank"
                rel="noreferrer"
              >
                {" "}
                juanimasmusic@gmail.com{" "}
              </a>{" "}
            </p>
          </div>
          {/* <ContactForm /> */}
