...
export default function Intro() {
	...
	return (
		<section id="intro" className={`relative flex flex-col items-center h-[calc(100vh-3rem)] w-full overflow-hidden max-h-[100vh] min-h-[100vh] lg:h-screen lg:flex-row lg:justify-start`} ref={sectionRef}>
			<BandIdentity />
			...
			<Container customClasses="flex flex-col justify-center items-center absolute left-1/2 top-[45%] -translate-x-1/2 -translate-y-1/2 lg:justify-end lg:items-end lg:top-1/2">
				<IntroTourDates />
			</Container>
